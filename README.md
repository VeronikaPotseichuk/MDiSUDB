...
2. **Возможности работы с сайтом**: 
    ...
    **Администратор**
    ...
    - Удалять профили сотрудников (своего филиала).
    ...
    **Менеджер**
    ...
    - Редактировать заказы по просьбе клиента.
    - Продавать готовое изделие, имеющееся в наличии в мастерской.
    - Создавать счёт на основе отчёта мастера-ювелира о задействованных материалах и расчитывать клиентов, помечая способ оплаты.

    **Мастер-ювелир**
    - Помечать, какой заказ взял на себя.
...
## База данных в 3 Нормальной форме
![image](3NF.jfif)
