...
* Ролевая система (администратор, персонал, клиент)
* Логирование
...
- Создавать и хранить записи о расходных материалах в каждой мастерской. (администратор, менеджер)
...
| cost     | INT, >0, не NULL   |    "от " cost  "рублей" |
